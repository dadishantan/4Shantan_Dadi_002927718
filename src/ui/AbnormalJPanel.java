...
public class AbnormalJPanel extends javax.swing.JPanel {
    ...
    public AbnormalJPanel(PatientDirectory abnormalCases, EncounterHistory encounterHistory, PersonDirectory personDirectory) {
        initComponents();
        this.abnormalDirectory = abnormalCases;
        this.abnormalEncounters = encounterHistory;
        this.personDirectory = personDirectory;
        lblTotal.setText(String.valueOf(this.personDirectory.getPersonDirectory().size()));
        populateTable();
    }
    ...
    private void initComponents() {
        ...
        layout.setVerticalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGap(19, 19, 19)
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(lblRox, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.PREFERRED_SIZE, 16, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private void btnSearchActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSearchActionPerformed
        ...
        for(Patient abPatient : abnormalDirectory.getPatientDirectory()){
        if(abPatient.getCommunity()!= null && abPatient.getCommunity().contains(searchItem)){
            abPatientDirectory.addPatient(abPatient);
        }
        populateSearchTable(abPatientDirectory);
        lblCases.setText("CASES IN"+" "+searchItem);
        lblRox.setText(String.valueOf(abPatientDirectory.getPatientDirectory().size()));
    ...
    private void populateTable() {
       DefaultTableModel model = (DefaultTableModel) tblAbnormalCases.getModel();
        model.setRowCount(0);
        for (Patient patient: abnormalDirectory.getPatientDirectory()){
        Object[] row = new Object[7];
        row[0] = patient;
        row[1] = patient.getFirstName();
        row[2] = patient.getLastName();
        row[3] = patient.getAge();
        row[4] = patient.getCommunity();
    ...
    private void populateSearchTable(PatientDirectory abPatientDirectory) {
        DefaultTableModel model = (DefaultTableModel) tblAbnormalCases.getModel();
        model.setRowCount(0);
        for (Patient patient: abPatientDirectory.getPatientDirectory()){
        Object[] row = new Object[7];
        row[0] = patient;
        row[1] = patient.getFirstName();
        row[2] = patient.getLastName();
